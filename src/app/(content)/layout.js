    ...
    <SidebarProvider>
      ...
      <div className="min-h-screen flex w-full bg-app">
        <Sidebar className="border-r border-sidebar sidebar-bg backdrop-blur-xl">
          ...
          <SidebarFooter className="border-t border-sidebar p-4">
            <div className="space-y-3">
              ...
              {/* Theme toggle */}
              <div>
                {/* The ThemeToggle is client-side and handles localStorage + class toggling */}
                <script
                ...
                />
                {
                  /* Import dynamically to avoid breaking server render */
                }
                <ThemeToggle />
              </div>
              <button
                // onClick={handleLogout}
                className="w-full flex items-center gap-2 px-4 py-2 text-sm text-muted hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors duration-200"
              >
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-surface backdrop-blur-xl border-b border-sidebar px-6 py-4 md:hidden">
